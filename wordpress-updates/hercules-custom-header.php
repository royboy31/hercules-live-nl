...
function hercules_custom_header_js() {
    ...
    (function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
             ...
             * ================================================ */
            var SEARCH_API = 'https://hercules-product-sync-nl.gilles-86d.workers.dev';
            ...
            function initSearchDropdown(searchInput, searchBtn, resultsContainer, form) {
                ...
                function renderResults(data) {
                    ...
                    data.data.forEach(function(p) {
                        var t = (p.thumbnail || '').replace('hercules-product-sync-fr.workers.dev', 'hercules-product-sync-nl.gilles-86d.workers.dev');
